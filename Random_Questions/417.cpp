...
public:
    ...
    vector<vector<int>> pacificAtlantic(vector<vector<int>> &heights)
    {
        ...
        vector<vector<bool>> pacificVisited(
            m, vector<bool>(n, false)); // pacificVisited[i][j] = true, means
                                        // [i][j] water can go to Pacific //m*n
        vector<vector<bool>> atlanticVisited(
            m, vector<bool>(n, false)); // atlanticVisited[i][j] = true, means
                                        // [i][j] water can go to atlantic //m*n
        // T.C : O(m*n)
        // S.C : O(m*n)
